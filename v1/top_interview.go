...
func findEvent() {
	pv2eventName := map[string]string{
		"newuserrpagepv":      "newuser_clean_rpage",
		"rpagemaincleanpv":    "clean_main_rpage",
		"rpagemainboostpv":    "boost_main_rpage",
		"rpagemainpowerpv":    "power_main_rpage",
		"rpagemaincpupv":      "cpu_main_rpage",
		"rpagemainsafepv":     "safe_main_rpage",
		"rpagemainclippv":     "clip_main_rpage",
		"rpagemainwifipv":     "wifi_main_rpage",
		"rpagemainpopcleanpv": "clean_retrieve_rpage",
		"rpagemainpopboostpv": "boost_retrieve_rpage",
		"rpagemainpoppowerpv": "power_retrieve_rpage",
		"rpagemainpopcpupv":   "cpu_retrieve_rpage",
		"rpagemainpopsafepv":  "safe_retrieve_rpage",
		"rpagemainpopclippv":  "clip_retrieve_rpage",
		"rpagemainpopwifipv":  "wifi_retrieve_rpage",
		"rpagepushclean1pv":   "clean_push_rpage",
		"rpagepushclean2pv":   "clean_push2_rpage",
		"rpagepushclean3pv":   "clean2_push2_rpage",
		"rpagepushboostpv":    "boost_push_rpage",
		"rpagepushpower1pv":   "power_push_rpage",
		"rpagepushpower2pv":   "power_push3_rpage",
		"rpagepushcpupv":      "cpu_push_rpage",
		"rpagepushsafepv":     "safe_push_rpage",
		"rpagepushclippv":     "clip_push_rpage",
		"rpagepushwifi1pv":    "wifi_push_rpage",
		"rpagepushwifi2pv":    "wifi_push2_rpage",
		"rpagepopclean1pv":    "clean_pop_rpage",
		"rpagepopclean2pv":    "clean_pop2_rpage",
		"rpagepopclean3pv":    "clean2_pop2_rpage",
		"rpagepopboostpv":     "boost_pop_rpage",
		"rpagepoppowerpv1":    "power_pop_rpage",
		"rpagepoppowerpv2":    "power_pop3_rpage",
		"rpagepopcpupv":       "cpu_pop_rpage",
		"rpagepopsafepv":      "safe_pop_rpage",
		"rpagepopclippv":      "clip_pop_rpage",
		"rpagepopwifi1pv":     "wifi_pop_rpage",
		"rpagepopwifi2pv":     "wifi_pop2_rpage",
		"rpageminicleanpv":    "mini_clean_rpage",
		"rpageminiboostpv":    "mini_boost_rpage",
		"rpageminicpupv":      "mini_cpu_rpage",
		"rpageminipowerpv":    "mini_power_rpage",
		"rpageminisafepv":     "mini_safe_rpage",
		"rpageminiwifipv":     "mini_wifi_rpage",
		"rpageminiclippv":     "mini_clip_rpage",
		"rpageczcleanpv":      "clean_perpush_rpage",
		"rpageczboostpv":      "boost_perpush_rpage",
		"rpageczpowerpv":      "power_perpush_rpage",
		"rpageczcpupv":        "cpu_perpush_rpage",
		"showreticleanpv":     "clean_retrieve_show",
		"showretiboostpv":     "boost_retrieve_show",
		"showretipowerpv":     "power_retrieve_show",
		"showreticpupv":       "cpu_retrieve_show",
		"showretisafepv":      "safe_retrieve_show",
		"showreticlippv":      "clip_retrieve_show",
		"showretiwifipv":      "wifi_retrieve_show",
		"clkreticleanpv":      "clean_retrieve_click",
		"clkretiboostpv":      "boost_retrieve_click",
		"clkretipowerpv":      "power_retrieve_click",
		"clkreticpupv":        "cpu_retrieve_click",
		"clkretisafepv":       "safe_retrieve_click",
		"clkreticlippv":       "clip_retrieve_click",
		"clkretiwifipv":       "wifi_retrieve_click",
		"clkmaincleanpv":      "clean_main_click",
		"clkmainboostpv":      "boost_main_click",
		"clkmainpowerpv":      "power_main_click",
		"clkmaincpupv":        "cpu_main_click",
		"clkmainsafepv":       "safe_main_click",
		"clkmainclippv":       "clip_main_click",
		"clkmainwifipv":       "wifi_main_click",
		"clkczcleanpv":        "clean_perpush_click",
		"clkczboostpv":        "boost_perpush_click",
		"clkczpowerpv":        "power_perpush_click",
		"clkczcpupv":          "cpu_perpush_click",
		"showpushclean1pv":    "clean_push_show",
		"showpushclean2pv":    "clean_push2_show",
		"showpushclean3pv":    "clean2_push2_show",
		"showpushboostpv":     "boost_push_show",
		"showpushpower1pv":    "power_push_show",
		"showpushpower2pv":    "power_push3_show",
		"showpushcpupv":       "cpu_push_show",
		"showpushsafepv":      "safe_push_show",
		"showpushclippv":      "clip_push_show",
		"showpushwifi1pv":     "wifi_push_show",
		"showpushwifi2pv":     "wifi_push2_show",
		"clkpushclean1pv":     "clean_push_click",
		"clkpushclean2pv":     "clean_push2_click",
		"clkpushclean3pv":     "clean2_push2_click",
		"clkpushboostpv":      "boost_push_click",
		"clkpushpower1pv":     "power_push_click",
		"clkpushpower2pv":     "power_push3_click",
		"clkpushcpupv":        "cpu_push_click",
		"clkpushsafepv":       "safe_push_click",
		"clkpushclippv":       "clip_push_click",
		"clkpushwifi1pv":      "wifi_push_click",
		"clkpushwifi2pv":      "wifi_push2_click",
		"showpopclean1pv":     "clean_pop_show",
		"showpopclean2pv":     "clean_pop2_show",
		"showpopclean3pv":     "clean2_pop2_show",
		"showpopboostpv":      "boost_pop_show",
		"showpoppowerpv1":     "power_pop_show",
		"showpoppowerpv2":     "power_pop3_show",
		"showpopcpupv":        "cpu_pop_show",
		"showpopsafepv":       "safe_pop_show",
		"showpopclippv":       "clip_pop_show",
		"showpopwifi1pv":      "wifi_pop_show",
		"showpopwifi2pv":      "wifi_pop2_show",
		"clkpopclean1pv":      "clean_pop_click",
		"clkpopclean2pv":      "clean_pop2_click",
		"clkpopclean3pv":      "clean2_pop2_click",
		"clkpopboostpv":       "boost_pop_click",
		"clkpoppower1pv":      "power_pop_click",
		"clkpoppower2pv":      "power_pop3_click",
		"clkpopcpupv":         "cpu_pop_click",
		"clkpopsafepv":        "safe_pop_click",
		"clkpopclippv":        "clip_pop_click",
		"clkpopwifi1pv":       "wifi_pop_click",
		"clkpopwifi2pv":       "wifi_pop2_click",
	}

	var pattern []string
	var str = ""
	start := 0
	for i := 0; i < len(str); i++ {
		if str[i] == '+' {
			tmp := str[start:i]
			pattern = append(pattern, tmp)
			start = i + 1
		}
	}
	var res []string
	for _, p := range pattern {
		res = append(res, pv2eventName[p])
	}
	fmt.Println(res)
}
